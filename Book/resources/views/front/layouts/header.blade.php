        ...
        <div class="section-container w-100 d-flex align-items-center gap-4 h-100">
          ...
          <ul class="nav__links gap-3 list-unstyled d-none d-lg-flex m-0">
            ...
            <form action="{{ route('logout') }}" method="POST">
              @csrf
              <li class="nav__link">
                <a class="d-flex align-items-center gap-2" href="{{ route('logout') }}">
            ...
            @if (auth()->user()->role=='admin')
              <li class="nav__link">
                <a class="d-flex align-items-center gap-2" href="{{route('products.index')}}">
                  <button class="btn"> التحكم</button>
                  <i class="fa-regular fa-user"></i>
                </a>
              </li>
            @endif
          ...
          @endauth 
            ...
            <li class="nav__link">
              <a class="d-flex align-items-center gap-2" href="favourites.html">
                <button class="btn"> المفضلة</button>
            ...
            <li class="nav__link">
              <a class="d-flex align-items-center gap-2" data-bs-toggle="offcanvas" data-bs-target="#nav__cart">
                <button class="btn"> عربة التسوق </button>
                <div class="position-relative">
